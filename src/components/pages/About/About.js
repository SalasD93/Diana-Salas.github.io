...
function About() {
    return (
        <Container>
            ...
            <p>My passion for problem solving makes this a great career choice. I genuinely love to debug and enhance code. I get that sense of accomplishment when I have successfully fixed code or made it better.</p>
            <p>I am a very empathetic person who usually understands what people like and need. I like to incorporate that personal characteristic with web development when constructing user-focused, mobile-responsive, and accessible web applications.</p>
        </Container>
    )
}
